...
//use by\component\pabank\orange_e\trade\ReceivableTradingApi;
...
//
//class ReceivableTradingTest extends TestCase
//{
//    /**
...
//        $api = new ReceivableTradingApi($config);
//        var_dump($req->toXml());
//        $result = $api->call($req);
//        $data = $result->getData();
